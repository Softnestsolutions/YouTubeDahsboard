                ...
                @foreach ($detail as $data)
                        ...
                        <div class="text-center card-body">
                            ...
                            <h5 class="mt-4 mb-2">
                                <span class="counter-value"
                                    data-target="">{{ number_format($data->subscriber_count) }}</span>
                            </h5>

                            <p class="text-slate-500 dark:text-zink-200">Total Subscriber</p>
                        </div>
                    </div><!--end col-->
                    <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                        <div class="text-center card-body">
                            ...
                            <h5 class="mt-4 mb-2"><span class="counter-value"
                                    data-target="">{{ number_format($data->video_count) }}</span></h5>
                    ...
                    <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                        <div class="text-center card-body">
                            ...
                            <h5 class="mt-4 mb-2"><span class="counter-value"
                                    data-target="">{{ number_format($data->view_count) }}</span></h5>
