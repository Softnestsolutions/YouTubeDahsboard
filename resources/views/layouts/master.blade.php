...
<head>
    ...
    <meta content="YouTube" name="author">
    <!-- App favicon -->
            ...
            <div
                ...
                <a href="{{ route('home') }}"
                    ...
                    <span class="hidden group-data-[sidebar-size=sm]:block">
                        <img src="{{ session('youtube.thumbnail') }}" alt="" class="h-6 mx-auto">
                    </span>
                            ...
                            <div class="relative flex items-center dropdown h-header">
                                ...
                                <div class="absolute z-50 hidden p-4 ltr:text-left rtl:text-right bg-white rounded-md shadow-md !top-4 dropdown-menu min-w-[14rem] dark:bg-zink-600"
                                    ...
                                    <h6 class="mb-2 text-sm font-normal text-slate-500 dark:text-zink-300">Welcome to
                                        YouTube Dashboard</h6>
                                    <a href="#!" class="flex gap-3 mb-3">
                                        <div class="relative inline-block shrink-0">
                                            <div class="rounded bg-slate-100 dark:bg-zink-500">
                                                <img src="{{ session('youtube.thumbnail') }}" alt=""
                                        ...
                                        <div>
                                            <h6 class="mb-1 text-15">YouTube</h6>
                                            <p class="text-slate-500 dark:text-zink-300">
                                                {{ session('youtube.title') }}</p>
                                        </div>
                                    </a>
                                    <ul>
                                        <li>
                    ...
                    <div
                        ...
                        <div class="hidden lg:block">
                            <div class="ltr:text-right rtl:text-left">
                                Dashboard {{ session('youtube.title') }}
                            </div>
                        </div>
                    </div>
                </div>
